...
pub struct ScopedMetadataKeyDto(pub u64);

impl ScopedMetadataKeyDto {
    ...
    /// Creates an `ScopedMetadataKeyDto` from a slice.
    ///
    /// # Returns
    /// A `ScopedMetadataKeyDto`.
