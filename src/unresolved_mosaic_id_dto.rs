...
pub struct UnresolvedMosaicIdDto(pub u64);

impl UnresolvedMosaicIdDto {
    ...
    ///
    /// # Returns
    /// A Unresolved mosaic id.
    pub fn get_unresolved_mosaic_id(&self) -> u64 {
        self.0
    }
    ...
    /// Creates an `UnresolvedMosaicIdDto` from a slice.
    ///
    /// # Returns
    /// A `UnresolvedMosaicIdDto`.
